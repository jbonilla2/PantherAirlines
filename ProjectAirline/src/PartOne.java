...
// defines the customer information
class Customer {  
	...
	public void createCustomer(String customerFirstname, String customerLastname, String customerAddress, String customerZip, String customerState, String customerUsername, String customerPassword, String customerEmail, String customerSSN, String customerSecurityQ) {
	...
	public void User() {
		...
		if((getcustomerUsername().equals(ID) && getcustomerPassword().equals(Pas))) {
							...
							while(YorN.equals("n")) {				
								...
								ID = in.next();
									if(c1.getcustomerUsername().equals(ID) == true) {
										...
										String Ans = in.next();
										if(c1.getcustomerSecurityQ().equals(Ans) == true) {
											System.out.println("The password for " +c1.getcustomerUsername() +" is "+ c1.getcustomerPassword());
										}else { 
											System.out.println("Incorrect answer for your security question?");
											System.out.println("Back to the main menu? Press 'n' if you want to keep trying(y/n)");
											YorN = in.next();
